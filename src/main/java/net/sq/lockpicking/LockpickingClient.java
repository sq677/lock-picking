...
import net.sq.lockpicking.UI.LockpickingScreen;
import net.sq.lockpicking.custom_data.CustomChestData;
import net.sq.lockpicking.entity.locks.bastion_lock.BastionLockModel;
import net.sq.lockpicking.entity.locks.bastion_lock.BastionLockRenderer;
import net.sq.lockpicking.entity.locks.copper_lock.CopperLockModel;
import net.sq.lockpicking.entity.locks.copper_lock.CopperLockRenderer;
import net.sq.lockpicking.entity.locks.diamond_lock.DiamonLockRenderer;
import net.sq.lockpicking.entity.locks.diamond_lock.DiamondLockModel;
import net.sq.lockpicking.entity.locks.golden_lock.GoldenLockModel;
import net.sq.lockpicking.entity.locks.golden_lock.GoldenLockRenderer;
import net.sq.lockpicking.entity.locks.iron_lock.IronLockModel;
import net.sq.lockpicking.entity.locks.iron_lock.IronLockRenderer;
import net.sq.lockpicking.entity.ModEntities;
import net.sq.lockpicking.entity.locks.netherite_lock.NetheriteLockModel;
import net.sq.lockpicking.entity.locks.netherite_lock.NetheriteLockRenderer;
