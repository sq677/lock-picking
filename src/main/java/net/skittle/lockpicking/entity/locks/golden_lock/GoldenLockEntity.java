...
public class GoldenLockEntity extends LockEntity {
    private static final TrackedData<Boolean> IS_OPENING = DataTracker.registerData(GoldenLockEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> IS_OPEN = DataTracker.registerData(GoldenLockEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public GoldenLockEntity(EntityType<?> type, World world) {
        super(type, world);
    ...
    public ActionResult interact(PlayerEntity player, Hand hand) {
        if (!this.getWorld().isClient && this.isOpen()) {
            if (this.chestPos != null) {
                ...
                if (be instanceof net.skittle.lockpicking.custom_data.CustomChestData customChest) {
            ...
            ItemStack lockStack = new ItemStack(ModItems.GOLDEN_LOCK, 1);
    ...
    private void unlockOtherHalf() {
        ...
        if (otherBE instanceof net.skittle.lockpicking.custom_data.CustomChestData otherChest) {
