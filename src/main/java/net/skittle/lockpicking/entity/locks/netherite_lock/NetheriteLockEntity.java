...
public class NetheriteLockEntity extends LockEntity {

    private static final TrackedData<Boolean> IS_OPENING = DataTracker.registerData(NetheriteLockEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> IS_OPEN = DataTracker.registerData(NetheriteLockEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public NetheriteLockEntity(EntityType<?> type, World world) {
        super(type, world);
    ...
    public ActionResult interact(PlayerEntity player, Hand hand) {
        if (!this.getWorld().isClient && this.isOpen()) {
            ...
            ItemStack lockStack = new ItemStack(ModItems.NETHERITE_LOCK, 1);
