...
public class IronLockEntity extends LockEntity {

    private static final TrackedData<Boolean> IS_OPENING = DataTracker.registerData(IronLockEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> IS_OPEN = DataTracker.registerData(IronLockEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public IronLockEntity(EntityType<?> type, World world) {
        super(type, world);
    ...
    public ActionResult interact(PlayerEntity player, Hand hand) {
        if (!this.getWorld().isClient && this.isOpen()) {
            ...
            ItemStack lockStack = new ItemStack(ModItems.IRON_LOCK, 1);
